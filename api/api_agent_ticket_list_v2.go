...
func (a *AgentTicketListV2APIService) AgentTicketListV2PostExecute(r ApiAgentTicketListV2PostRequest) (*AgentTicketListV2Response, *http.Response, error) {
	...
	if r.createTimeStart == nil {
		return localVarReturnValue, nil, reportError("createTimeStart is required and must be specified")
	}
	if r.createTimeEnd == nil {
		return localVarReturnValue, nil, reportError("createTimeEnd is required and must be specified")
	}
	if r.size == nil {
